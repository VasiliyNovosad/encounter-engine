Rails.application.configure do
  ...
  config.logger = ActiveSupport::TaggedLogging.new(Logdna::RailsLogger.new(ENV['LOGDNA_KEY'] || Rails.application.secrets.LOGDNA_KEY, {
    hostname: 'quest.wtf',
    level: 'DEBUG',
    env: 'PRODUCTION'
  }))
  ...
  config.action_mailer.default_url_options = { host: ENV['GMAIL_DOMAIN'] || Rails.application.secrets.GMAIL_DOMAIN, protocol: 'https' }
