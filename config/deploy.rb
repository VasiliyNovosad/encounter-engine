...
set :linked_files, fetch(:linked_files, []).push('config/database.yml', '.env', 'config/secrets.yml', 'config/cloudinary.yml', 'config/private_pub.yml', 'config/private_pub_redis.yml', 'config/private_pub_thin.yml')
