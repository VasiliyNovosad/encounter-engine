class LogsController < ApplicationController
  ...
  def show_special_results
    ...
    when 125
      ships = {
        'A1' => { id: 2987, ship: 'white' },
        'A2' => { id: 2988, ship: 'white' },
        'A3' => { id: 2989, ship: 'white' },
        'A4' => { id: 2990, ship: 'white' },
        'A5' => { id: 2991, ship: 'white' },
        'A6' => { id: 2992, ship: 'white' },
        'A7' => { id: 2993, ship: 'red' },
        'A8' => { id: 2994, ship: 'red' },
        'A9' => { id: 2995, ship: 'red' },
        'A10' => { id: 2996, ship: 'white' },
        'B1' => { id: 2997, ship: 'white' },
        'B2' => { id: 2998, ship: 'white' },
        'B3' => { id: 2999, ship: 'white' },
        'B4' => { id: 3000, ship: 'white' },
        'B5' => { id: 3001, ship: 'red' },
        'B6' => { id: 3002, ship: 'white' },
        'B7' => { id: 3003, ship: 'white' },
        'B8' => { id: 3004, ship: 'white' },
        'B9' => { id: 3005, ship: 'white' },
        'B10' => { id: 3006, ship: 'white' },
        'C1' => { id: 3007, ship: 'white' },
        'C2' => { id: 3008, ship: 'white' },
        'C3' => { id: 3009, ship: 'white' },
        'C4' => { id: 3010, ship: 'white' },
        'C5' => { id: 3011, ship: 'red' },
        'C6' => { id: 3012, ship: 'white' },
        'C7' => { id: 3013, ship: 'white' },
        'C8' => { id: 3014, ship: 'white' },
        'C9' => { id: 3015, ship: 'white' },
        'C10' => { id: 3016, ship: 'white' },
        'D1' => { id: 3017, ship: 'red' },
        'D2' => { id: 3018, ship: 'red' },
        'D3' => { id: 3019, ship: 'red' },
        'D4' => { id: 3020, ship: 'white' },
        'D5' => { id: 3021, ship: 'white' },
        'D6' => { id: 3022, ship: 'white' },
        'D7' => { id: 3023, ship: 'white' },
        'D8' => { id: 3024, ship: 'white' },
        'D9' => { id: 3025, ship: 'white' },
        'D10' => { id: 3026, ship: 'white' },
        'E1' => { id: 3027, ship: 'white' },
        'E2' => { id: 3028, ship: 'white' },
        'E3' => { id: 3029, ship: 'white' },
        'E4' => { id: 3030, ship: 'white' },
        'E5' => { id: 3031, ship: 'white' },
        'E6' => { id: 3032, ship: 'red' },
        'E7' => { id: 3033, ship: 'red' },
        'E8' => { id: 3034, ship: 'white' },
        'E9' => { id: 3035, ship: 'white' },
        'E10' => { id: 3036, ship: 'white' },
        'F1' => { id: 3037, ship: 'white' },
        'F2' => { id: 3038, ship: 'white' },
        'F3' => { id: 3039, ship: 'white' },
        'F4' => { id: 3040, ship: 'red' },
        'F5' => { id: 3041, ship: 'white' },
        'F6' => { id: 3042, ship: 'white' },
        'F7' => { id: 3043, ship: 'white' },
        'F8' => { id: 3044, ship: 'white' },
        'F9' => { id: 3045, ship: 'white' },
        'F10' => { id: 3046, ship: 'red' },
        'G1' => { id: 3047, ship: 'white' },
        'G2' => { id: 3048, ship: 'white' },
        'G3' => { id: 3049, ship: 'white' },
        'G4' => { id: 3050, ship: 'red' },
        'G5' => { id: 3051, ship: 'white' },
        'G6' => { id: 3052, ship: 'white' },
        'G7' => { id: 3053, ship: 'white' },
        'G8' => { id: 3054, ship: 'red' },
        'G9' => { id: 3055, ship: 'white' },
        'G10' => { id: 3056, ship: 'white' },
        'H1' => { id: 3057, ship: 'white' },
        'H2' => { id: 3058, ship: 'red' },
        'H3' => { id: 3059, ship: 'white' },
        'H4' => { id: 3060, ship: 'white' },
        'H5' => { id: 3061, ship: 'white' },
        'H6' => { id: 3062, ship: 'white' },
        'H7' => { id: 3063, ship: 'white' },
        'H8' => { id: 3064, ship: 'red' },
        'H9' => { id: 3065, ship: 'white' },
        'H10' => { id: 3066, ship: 'white' },
        'I1' => { id: 3067, ship: 'white' },
        'I2' => { id: 3068, ship: 'white' },
        'I3' => { id: 3069, ship: 'white' },
        'I4' => { id: 3070, ship: 'white' },
        'I5' => { id: 3071, ship: 'white' },
        'I6' => { id: 3072, ship: 'white' },
        'I7' => { id: 3073, ship: 'white' },
        'I8' => { id: 3074, ship: 'red' },
        'I9' => { id: 3075, ship: 'white' },
        'I10' => { id: 3076, ship: 'red' },
        'J1' => { id: 3077, ship: 'white' },
        'J2' => { id: 3078, ship: 'white' },
        'J3' => { id: 3079, ship: 'white' },
        'J4' => { id: 3080, ship: 'white' },
        'J5' => { id: 3081, ship: 'red' },
        'J6' => { id: 3082, ship: 'white' },
        'J7' => { id: 3083, ship: 'white' },
        'J8' => { id: 3084, ship: 'red' },
        'J9' => { id: 3085, ship: 'white' },
        'J10' => { id: 3086, ship: 'white' }
      }
    else
      return
    end
